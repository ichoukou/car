...
;(function (window, undefined) {
  ...
  function dateEvent() {
    ...
    var dataTime = null
    var ow = !!detail_festival[0] ? detail_festival[0].offsetWidth : 0;
    var oh = !!detail_festival[0] ? detail_festival[0].offsetHeight : 0;
    var popupPos = {lx: 0, lr: 0, y: 0, w: ow, h: oh}
    ...
    for (var i = 0; i < detail_festival.length; i++) {
      detail_festival[i].onclick = function (ev) {
        ...
        tools.renderPopup(this, popup, dateStr, $(this).attr('class'))
      ...
      //         popupPos.y = this.offsetTop - 50 + popupPos.h/2
      //
      //         popup.style.display = 'block'
      //         popup.style.top = popupPos.y + 'px'
      //
