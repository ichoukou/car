...
-- ----------------------------
INSERT INTO `website_company` VALUES (1, 0, '13656480135', 'CPY0000001', 'supercompany', '2', '3', '4', '5', '2017-03-22', '7', NULL, 5, 2, 0, 1, 'cc554b52696c1cab6dde8fd8c034ea226e4e0a01', 'eY0ue2D5vV', '2017-11-21 17:04:00', 1, '2017-04-28 16:01:32');
INSERT INTO `website_company` VALUES (3, 0, '13333333333', 'CPY0000003', 'test', '2', '3', '4', '5', '2017-03-22', '7', NULL, 0, NULL, 0, 1, 'cc554b52696c1cab6dde8fd8c034ea226e4e0a01', 'eY0ue2D5vV', '2017-11-18 11:11:46', 1, '2017-04-28 16:04:36');
INSERT INTO `website_company` VALUES (9, 0, '13666666666', 'CPY0000006', '1', '1', '1', '1', '1', '2017-03-22', '1', NULL, 0, NULL, 0, 1, '27bee50dc789a0389277ee95fa868a0ed36f2ab8', 'WqW44osPcs', '2017-11-20 06:19:41', 1, '2017-11-18 21:29:01');
INSERT INTO `website_company` VALUES (10, 0, '13555555555', 'CPY0000007', '1', '2', '3', '4', '5', '2017-03-22', '7', NULL, 0, 0, 0, 1, '7de8a58c8ca4c9f6e459b9d1b6d5c1c5721f436f', 'DUiRg7KX9E', NULL, 1, '2017-11-22 00:03:41');
INSERT INTO `website_company` VALUES (11, 0, '13655555555', 'CPY0000008', '1', '2', '3', '4', '5', '2017-03-22', '1', NULL, 0, 0, 0, 1, 'b486b1be8bede90f64ff25a041d8595bd4c19f94', 'j7VKVzCBRI', NULL, 1, '2017-11-22 00:40:42');
...
-- ----------------------------
INSERT INTO `website_reservation` VALUES (1, 1, 5, 4, NULL, '2017-12-30 10:30:00', 3, 1, '2017-11-19 22:01:35');
INSERT INTO `website_reservation` VALUES (2, 1, 5, 4, 'http://www.baidu.com/', '2017-12-20 10:30:00', 3, 1, '2017-11-21 10:19:45');
INSERT INTO `website_reservation` VALUES (3, 1, 5, 4, 'http://www.baidu.com/', '2017-12-12 10:30:00', 2, 1, '2017-11-21 22:32:24');
INSERT INTO `website_reservation` VALUES (4, 1, 5, 4, NULL, '2017-12-30 10:30:00', 1, 1, '2017-11-21 22:34:03');
INSERT INTO `website_reservation` VALUES (5, 1, 5, 4, NULL, '2017-12-28 10:30:00', 1, 1, '2017-11-21 22:34:35');
INSERT INTO `website_reservation` VALUES (6, 1, 5, 4, NULL, '2017-12-25 10:30:00', 1, 1, '2017-11-21 22:36:51');
...
CREATE TABLE `website_teaching`  (
  ...
  `title` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '课程名称',
  `setting_id` int(11) NULL DEFAULT NULL COMMENT '敏感期课程配置ID',
  `teaching_date` date NULL DEFAULT NULL COMMENT '上课日期',
  `teaching_start_time` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '上课开始时间',
  `teaching_end_time` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '上课结束时间',
  `deleted` tinyint(4) NULL DEFAULT 1 COMMENT '是否删除 1未删除 2已删除',
  `update_time` timestamp(0) NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP(0),
  `create_time` timestamp(0) NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`teaching_id`) USING BTREE,
  UNIQUE INDEX `TEACHING_ID`(`teaching_id`) USING BTREE,
  INDEX `USER_ID`(`user_id`) USING BTREE,
  INDEX `BABY_ID`(`baby_id`) USING BTREE,
  INDEX `TITLE`(`title`) USING BTREE,
  INDEX `CREATE_TIME`(`create_time`) USING BTREE,
  INDEX `USER_CARD_ID`(`user_card_id`) USING BTREE,
  INDEX `SETTING_ID`(`setting_id`) USING BTREE
...
CREATE TABLE `website_teaching_tools`  (
  ...
  `setting_id` int(11) NULL DEFAULT NULL,
  PRIMARY KEY (`teaching_tool_id`) USING BTREE,
  UNIQUE INDEX `TEACHING_TOOL_ID`(`teaching_tool_id`) USING BTREE,
...
-- ----------------------------
INSERT INTO `website_user` VALUES (5, '13666666666', 'USER0000001', '2e0c91d6ba239fb2150f53ef45d74b4c5122a09a', '0sIuh3GnA5', 1, '2017-11-21 15:32:14', '2017-11-19 13:29:16');
...
CREATE TABLE `website_user_address`  (
  ...
  `zone` int(11) NULL DEFAULT 0 COMMENT '地区',
  `address` text CHARACTER SET utf8 COLLATE utf8_general_ci NULL COMMENT '详细地址',
  `postcode` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '邮政编码',
  `default` tinyint(4) NULL DEFAULT 2 COMMENT '默认地址',
