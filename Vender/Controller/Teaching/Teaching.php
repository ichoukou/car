...
class Teaching extends Controller
{
    public function index()
    {
        ...
        $this->data['teachings'] = M::Admin('Teaching\\Teaching', 'findTeachings', ['params'=>$param]);
        $count = M::Admin('Teaching\\Teaching', 'findTeachingsCount', ['params'=>$param]);

        $pagination         = new Pagination();
        $pagination->total  = $count['total'];
        $pagination->page   = $param['page'];
        $pagination->limit  = $param['limit'];
        $pagination->url    = $this->data['entrance'] . "route=Admin/Teaching/Teaching&page={page}{$this->data['url']}";
        ...
        $this->data['search_url'] = "{$this->data['entrance']}route=Admin/Teaching/Teaching";

        $this->create_page();

        L::output(L::view('Teaching\\TeachingIndex', 'Admin', $this->data));
    }
