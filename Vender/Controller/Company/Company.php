...
class Company extends Controller
{
    ...
    public function do_add_company()
    {
        if ($post = $this->validate_default()) {
            ...
            if ($company_id > 0) {
                ...
                exit(json_encode(['status'=>-1, 'result'=>'新增企业信息失败'], JSON_UNESCAPED_UNICODE));
            }
        }
    }
    ...
    public function edit_company()
    {
        ...
        $company_info = M::Vender('Company\\Company', 'findCompanyByCompanyId', ['company_id'=>$company_id]);
...
//            }
            ...
            if (empty($post['numbering'])) {
                $errors ['numbering'] = '请填写会员编号';
            }
