...
class Account extends Controller
{
    ...
    public function register()
    {
        ...
        L::output(L::view('Account\\Register', 'Vender', $this->data));
    }
    ...
    public function do_login()
    {
        ...
        $result = M::Vender('Account\\Account', 'login', ['username'=>$username, 'password'=>$password]);

        if (!empty($result)) {
            $_SESSION['vender_id'] = $result['vender_id'];
            $_SESSION['vender_name'] = $result['username'];
    ...
    public function do_register()
    {
        ...
        $result = M::Vender('Account\\Account', 'register', ['username'=>$username, 'password'=>$password]);
