...
class Website extends Controller
{
    public function index()
    {
        ...
        $this->data['settings'] = M::Admin('Common\\Common', 'getSettings', ['module'=>'website']);
        ...
        $this->data['websites'] = M::Admin('System\\Website', 'findWebsites', ['params'=>$param]);
        $count = M::Admin('System\\Website', 'findWebsitesCount', ['params'=>$param]);

        $pagination         = new Pagination();
        $pagination->total  = $count['total'];
        $pagination->page   = $param['page'];
        $pagination->limit  = $param['limit'];
        $pagination->url    = $this->data['entrance'] . "route=Admin/System/Website&page={page}{$this->data['url']}";
        ...
        $this->data['search_url'] = "{$this->data['entrance']}route=Admin/System/Website";

        $this->create_page();

        L::output(L::view('System\\WebsiteIndex', 'Admin', $this->data));
    }
    ...
    public function add_website()
    {
        ...
        L::output(L::view('System\\WebsiteAdd', 'Admin', $this->data));
    }
    ...
    public function do_add_website()
    {
        if ($post = $this->validate_default()) {
            ...
            $website_id = M::Admin('System\\Website', 'addWebsite', ['post'=>$post]);
    ...
    public function edit_website()
    {
        ...
        if (empty($website_id))
            exit(header("location:{$this->data['entrance']}route=Admin/System/Website{$this->data['url']}"));

        $website_info = M::Admin('System\\Website', 'findWebsiteByWebsiteId', ['website_id'=>$website_id]);
        ...
        L::output(L::view('System\\WebsiteEdit', 'Admin', $this->data));
    }

    public function do_edit_website()
    {
        if ($post = $this->validate_edit()) {
            M::Admin('System\\Website', 'editWebsite', ['post'=>$post]);
    ...
    public function remove_one()
    {
        ...
        $return = M::Admin('System\\Website', 'removeWebsite', ['website_id'=>$website_id]);
    ...
    public function remove_some()
    {
        ...
        $return = M::Admin('System\\Website', 'removeWebsites', ['website_ids'=>$website_ids]);
